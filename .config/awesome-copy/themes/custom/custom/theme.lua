...
local themes_path = "/home/bastien/.config/awesome/"
local dpi = require("beautiful.xresources").apply_dpi

-- {{{ Main
local theme = {}
theme.wallpaper = themes_path .. "custom/wall.png"
-- }}}
...
--theme.fg_widget        = "#ebdbb2"
--theme.fg_center_widget = "#b16268"
--theme.fg_end_widget    = "#689d6a"
